...
public struct Stats {
    ...
    public Stats(float _health, float _damage, float _speed, float _turboMultiplier, float _damageReduction, float _shotSpeed)
    {
        health = _health;
        damage = _damage;
        speed = _speed;
...
public class ShipStats : MonoBehaviour {
	...
	public Stats _shipStats = new Stats(100f, 100f, 5f, 2f, 0.5f, 10f);
